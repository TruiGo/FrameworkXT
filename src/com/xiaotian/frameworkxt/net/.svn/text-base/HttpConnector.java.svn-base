...
public interface HttpConnector {
	...
	String sendPostFormFileRequestForString(String url, String fileName, File file, List<? extends HttpParam> requestParams)
			throws HttpNetworkException;

	<T extends HttpParam> String sendPostFormFileRequestForString(String url, String fileName, File file, T... requestParams)
			throws HttpNetworkException;
