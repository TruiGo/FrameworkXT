...
public class UtilPatternMatcher {
	...
	public static boolean matchMobileCN(String mobileNumber) {
		// 创建模式匹配器,匹配前缀+8位数字
	...
	public static boolean matchPhoneNumber(String mobileNumber) {
	...
	public static boolean matchNumberOrCharacter(String text) {
