...
public class MyOuter {
	...
	public void info(String message) {
		if (isOuter) System.out.println(message);
	}

	public void info(String TAG, String message) {
		if (isOuter) System.out.println(String.format("%1$s　　%2$s", TAG, message));
	}

	public void info(String TAG, Object message) {
		if (isOuter) info(TAG, message.toString());
	}
	...
	public void info(Object[] message, Boolean... newLine) {
		if (isOuter) if (newLine.length > 0 && newLine[0]) info(TAG, message, true);
